...
INSERT INTO "new_ShopSetting" ("autoUpdateEnabled", "consecutiveFailures", "createdAt", "id", "lastFailureAt", "minPricePct", "notificationEmail", "shopDomain", "updatedAt") SELECT "autoUpdateEnabled", "consecutiveFailures", "createdAt", "id", "lastFailureAt", "minPricePct", "notificationEmail", "shopDomain", "updatedAt" FROM "ShopSetting";
